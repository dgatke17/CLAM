...
from load_data.dataset_generic import Generic_WSI_Classification_Dataset, Generic_MIL_Dataset
...
parser.add_argument('--exp_code', type=str, default='CAMELYON16_test', help='experiment code for saving results')
